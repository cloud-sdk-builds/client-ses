...
[`@aws-sdk/client-ses`](https://www.npmjs.com/package/@aws-sdk/client-ses/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ses@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MM423DSs2LRSTAEtFwivwu/GIkbfmjtdk4z8ofIKSVg9JAPdRD5ot74BBx+3Ttmk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ses": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ses@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ses@3.252.0/index.min.mjs": "sha384-MM423DSs2LRSTAEtFwivwu/GIkbfmjtdk4z8ofIKSVg9JAPdRD5ot74BBx+3Ttmk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ses/blob/refs/tags/3.252.0/LICENSE
```
